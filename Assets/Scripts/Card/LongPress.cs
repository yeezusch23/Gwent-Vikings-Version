    ...
    public void OnLongPress()
    {
        ...
        if(controller.roundCount < 2 && controller.changedCard < 2){
            ...
            {   
                ...
                controller.vikingsDeck.AddCard(new Card(card.name, card.id, card.faction, card.type, card.power, card.row, card.effect));
                ...
                controller.lastKingdomDeck.AddCard(new Card(card.name, card.id, card.faction, card.type, card.power, card.row, card.effect));
